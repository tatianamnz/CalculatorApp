    ...
    'no-restricted-imports': [
      'error',
      {
        paths: [
          {
            name: 'react-native',
            importNames: ['TextInput', 'ScrollView', 'Text', 'Pressable', 'View', 'StyleSheet', 'Card'],
            message: 'import from ui/_components instead '
          },
          {
            name: 'awilix',
            importNames: ['asValue', 'asFunction', 'asClass'],
            message: 'import from _di/resolvers '
          }
        ],
        patterns: [
          {
            group: ['lodash/*', 'lodash'],
            message: 'import from core/shared/domain/utils instead '
          }
        ]
      }
    ],
